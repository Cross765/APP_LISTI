...
import os
import sys
from Funciones import registrar_usuario, login, verificar_codigo
...
img_fondo=cargar_icono("C:/Users/Usuario/Desktop/Clases/Proyecto de año/Registro/Imagenes/fondo.png")
...
def abrir_menu(usuario=None):
    ...
    ruta=os.path.join(os.path.dirname(__file__), "../Menu.py")
...
ojo_abierto=cargar_icono("C:/Users/Usuario/Desktop/Clases/Proyecto de año/Registro/Imagenes/ojo_abierto.png")
ojo_abierto.configure(size=(25, 25))
ojo_cerrado=cargar_icono("C:/Users/Usuario/Desktop/Clases/Proyecto de año/Registro/Imagenes/ojo_cerrado.png")
